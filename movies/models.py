...
class Movie(models.Model):
    ...
    directors = models.ManyToManyField(Staff, verbose_name="режиссеры", related_name="film_director")
    actors = models.ManyToManyField(Staff, verbose_name="актеры", related_name="film_actor")
...
class MovieShots(models.Model):
    ...
    movie = models.ForeignKey(Movie, verbose_name="Видео", on_delete=models.CASCADE)

    def __str__(self):
        return self.title

    class Meta:
        verbose_name = "Кадры из видео"
