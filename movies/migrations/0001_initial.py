# Generated by Django 3.0.3 on 2021-12-22 11:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.Service', verbose_name='Видео')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='service',
            name='actors',
            field=models.ManyToManyField(related_name='film_actor', to='movies.Staff', verbose_name='актеры'),
        ),
        migrations.AddField(
            model_name='service',
            name='category',
        ...
        migrations.AddField(
            model_name='service',
            name='directors',
            field=models.ManyToManyField(related_name='film_director', to='movies.Staff', verbose_name='режиссеры'),
        ),
        migrations.AddField(
            model_name='service',
            name='genres',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.fields.CharField, to='movies.Service', verbose_name='видео')),
